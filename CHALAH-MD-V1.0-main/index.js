...
async function connectToWA() {
  ...
  robin.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      console.log("CHALAH MD  installed successful ✅");
      console.log("CHALAH MD  connected to whatsapp ✅");

      let up = `CHALAH MD connected successful ✅`;
      let up1 = `Hello CHALAH , I made bot successful`;

      robin.sendMessage(ownerNumber + "@s.whatsapp.net", {
        image: {
          url: `https://files.catbox.moe/8uu0ns.jpg`,
        },
        caption: up,
      });
      robin.sendMessage("94776938009@s.whatsapp.net", {
        image: {
          url: `https://files.catbox.moe/8uu0ns.jpg`,
        },
        caption: up1,
...
app.get("/", (req, res) => {
  res.send("hey, CHALAH MD started✅");
});
app.listen(port, () =>
